...
import com.hzxy.modules.sys.service.ShiroService;
...
public class SysMenuController extends AbstractController {
	...
	@GetMapping("/nav")
	public R nav(){
		List<SysMenuEntity> menuList = sysMenuService.getUserMenuList(getUserId(),"1");
	...
	public R list(){
		List<SysMenuEntity> menuList = sysMenuService.getUserMenuList(getUserId(),"0");
		R r=R.ok().put("data", menuList);
		r.getJsonStr();
		return r;
	}
	...
	public R info(@PathVariable("menuId") Long menuId){
		...
		if(menu.getParentId()!=0) {
			SysMenuEntity menu1 = sysMenuService.getById(menu.getParentId());
